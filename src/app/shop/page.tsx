...
export default function ShopPage() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      if (error) {
        ...
        // Extraemos las categorías únicas automáticamente de la base de datos
        // Si el admin crea una categoría nueva, aparecerá sola acá.
  ...
  return (
    <div className="min-h-screen bg-white pt-32 pb-20 font-sans text-black">
      ...
      {/* Contenedor Principal (Flex para separar Sidebar del Grid) */}
      <div className="max-w-[1600px] mx-auto px-6 flex flex-col md:flex-row gap-12">
        ...
        <aside className="w-full md:w-64 shrink-0 flex flex-col gap-10">
          ...
          {/* Filtros visuales (Igual a la imagen) */}
          <div>
            ...
            {filteredProducts.map((p) => (
              <div key={p.id} className="group relative flex flex-col">
                ...
                <Link href={`/shop/${p.id}`} className="relative bg-gray-100 aspect-[3/4] overflow-hidden mb-4 block">
                  ...
                  {/* Etiqueta Promo (Opcional, estilo Kongo) */}
                ...
                {/* ================= BOTONES HOVER (Estilo Kongo) ================= */}
                {/* Aparecen al pasar el mouse por encima de la tarjeta */}
                  ...
                  <button 
                    onClick={(e) => {
                      ...
                      addToCart({ 
                        ...
                        name: p.title, 
                        price: p.price, 
                        size: "M", // Talle por defecto al agregar rápido
                        quantity: 1, 
